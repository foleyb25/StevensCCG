<template>
    <div class="relative w-screen overflow-hidden">
        <div class="absolute top-0 left-0 bg-black opacity-50 z-0 w-full h-full">hello</div>
            <video autoplay muted loop class="w-auto min-h-full min-w-full z-[-1]">
                <source :src="heroVideo" type="video/mp4">
                Your browser does not support the video tag.
            </video>
            <!-- Your hero content goes here -->
            <div class="font-din hero-content absolute top-8 left-0 z-10 w-full h-full flex flex-row justify-center items-center text-center  text-white">
                ...
                <div id="tagline" class="w-1/2 flex flex-col justify-start items-start">
...
<script setup>
import heroVideo from "/src/assets/videos/heroVideo.mp4"
